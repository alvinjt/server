...
final readonly class ExpirationDateShareProperty extends ASharePropertyDate implements ISharePropertyFilter {
	#[\Override]
	public function isFiltered(ShareAccessContext $accessContext, Share $share): bool {
		foreach ($share->properties as $property) {
			if ($property->type === self::class && $property->value !== null) {
