...
use OCA\Files\Sharing\Property\NodeGridViewShareProperty;
...
class Application extends App implements IBootstrap {
	...
	public function register(IRegistrationContext $context): void {
		...
		$registry->registerProperty(new NodeGridViewShareProperty());
		$registry->registerPropertyCompatibleWithSourceType(NodeGridViewShareProperty::class, NodeShareSourceType::class);
		$registry->registerPropertyCompatibleWithRecipientType(NodeGridViewShareProperty::class, TokenShareRecipientType::class);
		$registry->registerPermission(NodeShareSourceType::class, new NodeCreateSharePermission());
		$registry->registerPermission(NodeShareSourceType::class, new NodeReadSharePermission());
		$registry->registerPermission(NodeShareSourceType::class, new NodeUpdateSharePermission());
		$registry->registerPermission(NodeShareSourceType::class, new NodeDeleteSharePermission());
		$registry->registerPermission(NodeShareSourceType::class, new NodeDownloadSharePermission());
	}
