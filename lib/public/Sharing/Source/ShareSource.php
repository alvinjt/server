...
final readonly class ShareSource {
	...
	public function format(bool $isUnique): array {
		if (($sourceType = (Server::get(IRegistry::class)->getSourceTypes()[$this->type] ?? null)) === null) {
			throw new ShareInvalidException('The source type is not registered: ' . $this->type);
		}
