...
final readonly class ShareRecipient {
	...
	public function format(bool $isUnique): array {
		if (($recipientType = (Server::get(IRegistry::class)->getRecipientTypes()[$this->type] ?? null)) === null) {
			throw new ShareInvalidException('The recipient type is not registered: ' . $this->type);
		}
